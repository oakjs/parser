...
export class SpellEvent {
   ...
   *
   * To apply for all instances of a class, use `Eventful` below:
   */
  static makeEventful(target) {
    ...
    target.trigger = function trigger(event) {
      SpellEvent.trigger(target, event)
    }
  }
}
