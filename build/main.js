...
parser.addRule("whitespace", new (function (_Rule$Pattern) {
...
parser.addRule("identifier", new (function (_Rule$Pattern2) {
...
parser.addRule("Type", new (function (_Rule$Pattern3) {
...
parser.addRule("number", new (function (_Rule$Pattern4) {
...
parser.addRule("text", new (function (_Rule$Pattern5) {
...
parser.addRule("boolean", new (function (_Rule$Pattern6) {
...
parser.addSyntax("literal-list", "\\[[list:{literal},]?\\]", {
...
parser.addStatement("declare-property", "{scope-modifier}? {identifier} = {literal}", {
	toSource: function toSource(context) {
...
parser.addStatement("declare-property-as-one-of", "{identifier} as one of {list:literal-list}", {
	toSource: function toSource(context) {
		var args = this.gatherArguments();
...
if (typeof window !== "undefined") {
	...
	window.parser = _rules2.default;
}

exports.default = {
	TextStream: _TextStream2.default, Parser: _Parser2.default, Rule: _Rule2.default, parser: _rules2.default
};
