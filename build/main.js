...
var position_expression = function (_Rule$Expression) {
...
_parser2.default.addExpression("position_expression", "{identifier} (#)?{position:expression} of (the?) {expression}", position_expression);
