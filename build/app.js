...
var Parser = (_temp = _class = function () {
	...
	_createClass(Parser, [{
		...
		key: "testRule",
		value: function testRule(ruleName, tokens, start, end) {
			var imports = this.imports,
			    index = 0,
			    parser = void 0;
			while (parser = imports[index++]) {
				var rule = parser._rules[ruleName];
				if (!rule) continue;
				var result = rule.test(this, tokens, start, end);
