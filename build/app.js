...
exports.showReturns = showReturns;
...
parser.defineRules({
  ...
  tests: [{
    ...
    compileAs: "statement",
    tests: [["if a then", "if (a) {}"], ["if a then b = 1", "if (a) { b = 1 }"], ["if a: b = 1", "if (a) { b = 1 }"], ["if a : b = 1", "if (a) { b = 1 }"]]
  }, {
...
// NOTE: this is NOT a block statement... ???
{
  ...
  tests: [{
    ...
    compileAs: "statement",
    tests: [["else", "else {}"], ["otherwise", "else {}"], ["else b = 1", "else { b = 1 }"]]
  }, {
    //TESTME: test nested blocks
