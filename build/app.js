...
var Parser = (_temp = _class = function () {
	...
	_createClass(Parser, [{
		...
		value: function parse(ruleName, text) {
			...
			if (ruleName !== "statements") {
				tokens = _Tokenizer2.default.eatWhitespaceTokens(tokens);
			}
	...
	return Parser;
}(), _class.DEBUG = false, _class.TIME = false, _class.REGISTRY = {}, _class.REGEXP_SPECIAL_CHARACTERS = function () {
	var chars = {};
	...
	_createClass(scope, [{
		...
		value: function parse(parser, tokens) {
			...
			lines.forEach(function (tokens) {
				...
				var lineResult = _this15.parseLine(parser, lastIndent, tokens);
				if (lineResult) {
			...
			while (lastIndent > 0) {
				var closeBlock = new Rule.CloseBlock({ indent: (0, _string.getTabs)(lastIndent - 1) });
		...
		key: "parseLine",
		value: function parseLine(parser, lastIndent, tokens) {
			var results = [];
			...
			var comment = parser.parseRuleOrDie("comment", tokens, tokens.length - 1);
			if (comment) {
				// remember indent
...
Rule.Statements = function (_Rule$NestedScope) {
	_inherits(statements, _Rule$NestedScope);
...
Rule.BlankLine = function (_Rule9) {
	_inherits(blank_line, _Rule9);
...
Rule.OpenBlock = function (_Rule10) {
	_inherits(open_block, _Rule10);
...
Rule.CloseBlock = function (_Rule11) {
	_inherits(close_block, _Rule11);
...
Rule.ParseError = function (_Rule12) {
	_inherits(parse_error, _Rule12);
...
Rule.Comment = function (_Rule13) {
	_inherits(comment, _Rule13);
...
var Tokenizer = {
	...
	eatWhitespaceTokens: function eatWhitespaceTokens(tokens) {
		var start = 0;
	...
	breakIntoLines: function breakIntoLines(tokens) {
		...
		lines.forEach(function (line) {
			return line.indent = Tokenizer.getLineIndent(line);
		});
	...
	getOutdentedLine: function getOutdentedLine(lines, indent) {
		var lastValidLine = 0;
		for (var index = 0, last = lines.length; index < last; index++) {
			var line = lines[index];
			// skip empty lines
			if (line.length === 0) continue;
			var lineIndent = Tokenizer.getLineIndent(line[0]);
