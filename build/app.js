...
parser.addStatement("define_type", "define type {type} (?:as (a|an) {superType:type})?", function (_Rule$BlockStatement) {
...
parser.addStatement("declare_method", "(to|on) {identifier} {args}? (\\:)? {statement}?", function (_Rule$BlockStatement2) {
...
//TESTME
parser.addStatement("declare_action", "action (keywords:{word}|{type})+ (\\:)? {statement}?", function (_Rule$BlockStatement3) {
...
parser.addStatement("getter", "get {identifier} (\\:)? {expression}?", function (_Rule$BlockStatement4) {
...
parser.addStatement("setter", "set {identifier} {args}? (\\:)? {statement}?", function (_Rule$BlockStatement5) {
...
parser.addStatement("declare_property", "(scope:property|constant|shared property) {identifier} (?:= {value:expression})?", function (_Rule$Statement) {
...
// TODO: scope_modifier???
// TODO: initial value
parser.addStatement("declare_property_of_type", "property {identifier} as (a|an)? {type}", function (_Rule$Statement2) {
...
parser.addStatement("declare_property_as_one_of", "property {identifier} as one of {list:literal_list}", function (_Rule$Statement3) {
